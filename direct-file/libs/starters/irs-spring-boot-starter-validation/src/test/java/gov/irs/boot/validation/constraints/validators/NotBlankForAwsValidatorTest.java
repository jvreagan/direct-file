...
class NotBlankForAwsValidatorTest {

    @Mock
    private Environment env;

    private NotBlankForAwsValidator validator;

    @BeforeEach
    void setUp() {
        validator = new NotBlankForAwsValidator(env);
    }

    @Test
    void givenAwsProfile_whenBlankValue_thenReturnsFalse() {
    ...
    @Test
    void givenNonAwsProfile_whenBlankValue_thenReturnsTrue() {
